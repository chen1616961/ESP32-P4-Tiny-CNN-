...
extern const uint8_t tiny_cls_model_start[] asm("_binary_tiny_cls_96_6cls_s8_p4_espdl_start");
extern const uint8_t tiny_cls_model_end[] asm("_binary_tiny_cls_96_6cls_s8_p4_espdl_end");
...
static esp_err_t ensure_model(void)
{
    ...
    if (!s_preprocessor) {
         ...
         * [1,96,96,3], so ImagePreprocessor can resize and quantize directly.
         */
